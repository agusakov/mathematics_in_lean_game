...
add_decl $ d.update_name $ d.to_name.update_prefix `maths_in_lean_game.interactive
...
@[reducible] meta def maths_in_lean_game := tactic

namespace maths_in_lean_game

--meta instance : monad maths_in_lean_game := by delta maths_in_lean_game; apply_instance

--meta instance : alternative maths_in_lean_game := by delta maths_in_lean_game; apply_instance

meta def step {α} (c : maths_in_lean_game α) : maths_in_lean_game unit := 
c >> return ()
...
meta def execute (c : maths_in_lean_game unit) : maths_in_lean_game unit := 
c
...
end maths_in_lean_game

--#check tactic.interactive.induction

namespace maths_in_lean_game.interactive
...
end maths_in_lean_game.interactive
